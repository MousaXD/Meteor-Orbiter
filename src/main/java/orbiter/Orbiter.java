...
import orbiter.commands.ServerCapsCommand;
import orbiter.commands.ServerCopyCommand;
import orbiter.commands.ServerNetworkCommand;
...
import orbiter.hud.ServerNetworkHud;
...
public class Orbiter extends MeteorAddon {
    ...
    public void onInitialize() {
        ...
        try {
            ...
            Commands.add(new ServerNetworkCommand());
            Commands.add(new ServerCapsCommand());
            Commands.add(new ServerCopyCommand());
        ...
        try {
            ...
            if (hud != null) {
                ...
                hud.register(ServerNetworkHud.INFO);
